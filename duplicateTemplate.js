...
function showCreateSheetsDialog() {
  ...
  const html = HtmlService.createHtmlOutput(`
    ...
    <label>Sheet name with names (e.g. Summary):</label>
    <input type="text" id="sheet" value="Summary" placeholder="Summary">
    
    <label>Range with names (e.g. A53:A59):</label>
    <input type="text" id="range" value="A53:A59" placeholder="A53:A59">

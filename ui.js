...
function buildAdminSidebarCard() {
  ...
  // ── Section 2: Duplicate Template ──────────────────────────────────────────
  const duplicateSection = CardService.newCardSection()
                                      .setHeader('Duplicate School Entry Sheets')
                                      .setCollapsible(true)
                                      .addWidget(
                                        CardService.newTextParagraph()
                                      ...
                                      .addWidget(
                                        CardService.newButtonSet()
                                                   .addButton(
                                                     CardService.newTextButton()
                                                                .setText('Duplicate Sheet')
                                                                .setTextButtonStyle(CardService.TextButtonStyle.FILLED)
                                                                .setBackgroundColor('#34A853') // Google green
                                                                .setOnClickAction(CardService.newAction()
                                                                                             .setFunctionName('duplicateTemplateForNames'))
                                                   )
                                      );

  // ── Section 3: Export Entries ──────────────────────────────────────────
